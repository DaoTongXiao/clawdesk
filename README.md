...
![ClawDesk Preview](./preview.png)

## Acknowledgements

This project is forked from [chatclaw](https://github.com/idoubi/chatclaw).
...
```bash
# Clone
git clone https://github.com/DaoTongXiao/clawdesk.git
cd clawdesk
...
ClawDesk connects to an [OpenClaw](https://github.com/openclaw/openclaw) Gateway instance via WebSocket. You need a running Gateway with:
